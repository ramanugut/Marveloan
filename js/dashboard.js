        function navigate(page) {
            ...
            const config = {
                'customers': { title: 'Customer Management 👥', subtitle: 'Manage all your customers and their profiles in one place.' },
                'applications': { title: 'Loan Applications 📝', subtitle: 'Review and process new loan applications.' },
                'collections': { title: 'Collections Management 💰', subtitle: 'Track and manage loan repayments and overdue accounts.' },
                'reports': { title: 'Reports & Analytics 📊', subtitle: 'Generate comprehensive reports and business insights.' },
                'cashbook': { title: 'Cash Book 📚', subtitle: 'Manage your daily cash transactions and balances.' },
                'disbursement': { title: 'Loan Disbursement 💸', subtitle: 'Disburse approved loans to customers efficiently.' }
            };
            if (config[page]) {
